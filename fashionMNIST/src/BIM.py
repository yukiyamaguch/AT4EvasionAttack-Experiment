...
parser = argparse.ArgumentParser(description='Basic Iterative Method test program')
...
# generate AE
attack = BasicIterativeMethod(estimator=classifier, eps=epsilon, targeted=True)
