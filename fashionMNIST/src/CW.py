...
parser = argparse.ArgumentParser(description='Carlini and Wagner attack test program')
...
# generate AE
attack = CarliniL2Method(classifier=classifier, confidence=confidence, targeted=True, max_iter=20, learning_rate=0.02)
