...
parser = argparse.ArgumentParser(description='Projected Gradient Descent test program')
...
# generate AE
attack = ProjectedGradientDescent(estimator=classifier, eps=epsilon, targeted=True)
