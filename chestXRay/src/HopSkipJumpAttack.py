...
parser = argparse.ArgumentParser(description='HopSkipJump Attack test program')
...
# generate AE
#attack = HopSkipJump(classifier=classifier, targeted=True, max_iter=10000, delta=0.01, epsilon=0.1, min_epsilon=0)
attack = HopSkipJump(classifier=classifier, norm=2, targeted=False, max_iter=query, max_eval=100, init_eval=10)
