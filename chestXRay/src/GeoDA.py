...
parser = argparse.ArgumentParser(description='Geometric Decision Based Attack test program')
...
# generate AE
attack = GeoDA(estimator=classifier, norm=2, sub_dim=5, bin_search_tol=0.5, sigma=0.2, max_iter=query)
